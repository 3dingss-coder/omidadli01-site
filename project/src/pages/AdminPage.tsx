              ...
              <div className="p-6 rounded-3xl bg-[#120a38]/80 border border-white/10 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                  {[
                    ...
                    { id: 'business-analysis', label: 'تحلیل بیزینس', slug: '/business-analysis' },
          ...
          {activeTab === 'blog' && (
            <div className="space-y-6">
              <div className="p-6 rounded-3xl bg-[#120a38]/80 border border-white/10 space-y-4">
                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                  <h3 className="text-base font-black text-amber-400">
                    مدیریت مقالات و نوشته‌ها ({data.BLOG_POSTS?.length || 0})
                  </h3>
                  <button
                    onClick={() => addItem('BLOG_POSTS')}
                    className="px-4 py-2 rounded-xl bg-amber-400 hover:bg-amber-300 text-slate-950 font-black text-xs flex items-center gap-1.5 shadow-lg"
                  >
                    <Plus className="w-4 h-4" />
                ...
                <div className="space-y-4">
                  {data.BLOG_POSTS?.map((post, idx) => (
                    <div key={post.id || idx} className="p-5 rounded-2xl bg-white/5 border border-white/10 space-y-3 text-xs">
                      <div className="flex items-center justify-between border-b border-white/10 pb-2">
                        <span className="font-black text-white text-sm">
                          #{idx + 1} - {post.title}
                        </span>
                        <button
                          onClick={() => removeItem('BLOG_POSTS', idx)}
                          className="p-2 rounded-xl bg-rose-500/20 hover:bg-rose-500 text-rose-300 hover:text-white transition-all"
                        >
                          <Trash2 className="w-4 h-4" />
                        </button>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="sm:col-span-2">
                          <label className="block text-slate-400 mb-1">عنوان مقاله:</label>
                          <input
                            type="text"
                            value={post.title}
                        ...
                        <div>
                          <label className="block text-slate-400 mb-1">دسته‌بندی (فارسی):</label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="block text-slate-400 mb-1">زمان مطالعه:</label>
                          <input
                            type="text"
                            value={post.readTime}
                        ...
                        <div className="sm:col-span-2">
                          <label className="block text-slate-400 mb-1">چکیده / خلاصه مقاله:</label>
                          <textarea
                            value={post.excerpt}
          ...
          {activeTab === 'products' && (
            <div className="space-y-6">
              <div className="p-6 rounded-3xl bg-[#120a38]/80 border border-white/10 space-y-4">
                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                  <h3 className="text-base font-black text-amber-400">
                    مدیریت محصولات و دوره‌ها ({data.PRODUCTS?.length || 0})
                  </h3>
                  <button
                  ...
                  {data.PRODUCTS?.map((prod, idx) => (
                    <div key={prod.id || idx} className="p-5 rounded-2xl bg-white/5 border border-white/10 space-y-3 text-xs">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div>
                          <label className="block text-slate-400 mb-1">نشان / جدید / محبوب:</label>
                          <input
                            type="text"
                            value={prod.badge || ''}
