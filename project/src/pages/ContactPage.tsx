            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    <label className={`block text-xs font-bold mb-2 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>آدرس ایمیل کاری *</label>
                    <input
                      type="email"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className={`block text-xs font-bold mb-2 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>شماره تماس یا آیدی تلگرام *</label>
                    <input
                      type="text"
                      required
                  ...
                  <div>
                    <label className={`block text-xs font-bold mb-2 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>بودجه تبلیغات ماهانه مد نظر</label>
                    <select
                    ...
                    >
                      <option value="زیر ۵۰ میلیون تومان">زیر ۵۰ میلیون تومان ماهانه</option>
                      <option value="۵۰ تا ۱۰۰ میلیون تومان">۵۰ تا ۱۰۰ میلیون تومان ماهانه</option>
                      <option value="۱۰۰ تا ۳۰۰ میلیون تومان">۱۰۰ تا ۳۰۰ میلیون تومان ماهانه</option>
                      <option value="بالای ۳۰۰ میلیون تومان">بالای ۳۰۰ میلیون تومان (سازمانی)</option>
                    </select>
                  </div>
                </div>

                <div>
                  <label className={`block text-xs font-bold mb-2 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>نوع سرویس مورد نیاز</label>
                  <select
                ...
                <div>
                  <label className={`block text-xs font-bold mb-2 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>توضیحات مختصر درباره کسب‌وکار و آدرس وب‌سایت</label>
                  <textarea
                    rows={4}
